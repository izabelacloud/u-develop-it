...
//importing input check from Utils
...
app.post('/api/candidate', ({ body }, res) => {
  ...
  //route to update the candidate table with PUT request
...
//get route to all parties table
